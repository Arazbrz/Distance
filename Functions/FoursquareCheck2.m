function [fault,i1,i2,i3,i4]=FoursquareCheck2(rtest1,xtest1,z1,k)
...
% KR(1,:)=linspace(-1.4*(imag(z1)*tand(80)),53.17,1000);
% KR(2,:)=linspace(1.4*imag(z1),1.4*imag(z1),1000);
% JX(1,:)=linspace(0,1.4*imag(z1),1000);
% JX(2,:)=linspace(0,-1.4*(imag(z1)*tand(80)),1000);
% KX(1,:)=linspace(b,1.4*imag(z1),1000);
% KX(2,:)=linspace(a,53.17,1000);
%locating of rtest1
for i1=1:1000
    if(rtest1>JR(1,i1))
        rtest1J=JR(1,i1);
