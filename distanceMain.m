...
AG=Foursquaretrip(rtest,xtest,z1,0.85,cri1);
AG2=Foursquaretrip(rtest,xtest,z1,1.5,cri2);
AG3=Foursquaretrip(rtest,xtest,z1,2.2,cri3);
...
sAG2=num2str(AG2);
sAG3=num2str(AG3);
title(['AG: ',' zone1=',sAG,' zone2=',sAG2,' zone3=',sAG3])
hold on 
zone1(z1)
zone2(z1)
zone3(z1)
...
[rtest,xtest]=pol2cart(deg2rad(vtestF-itestF),vtestD./itestD);
BG=Foursquaretrip(rtest,xtest,z1,0.85,cri1);
BG2=Foursquaretrip(rtest,xtest,z1,1.5,cri2);
BG3=Foursquaretrip(rtest,xtest,z1,2.2,cri3);
...
sBG2=num2str(BG2);
sBG3=num2str(BG3);
title(['BG: ',' zone1=',sBG,' zone2=',sBG2,' zone3=',sBG3])
hold on 
zone1(z1)
zone2(z1)
zone3(z1)
...
[rtest,xtest]=pol2cart(deg2rad(vtestF-itestF),vtestD./itestD);
CG=Foursquaretrip(rtest,xtest,z1,0.85,cri1);
CG2=Foursquaretrip(rtest,xtest,z1,1.5,cri2);
CG3=Foursquaretrip(rtest,xtest,z1,2.2,cri3);
...
sCG2=num2str(CG2);
sCG3=num2str(CG3);
title(['CG: ',' zone1=',sCG,' zone2=',sCG2,' zone3=',sCG3])
hold on 
zone1(z1)
zone2(z1)
zone3(z1)
...
[rtest,xtest]=pol2cart(deg2rad(vtestF-itestF),vtestD./itestD);
AB=Foursquaretrip(rtest,xtest,z1,0.85,cri1);
AB2=Foursquaretrip(rtest,xtest,z1,1.5,cri2);
AB3=Foursquaretrip(rtest,xtest,z1,2.2,cri3);
...
sAB2=num2str(AB2);
sAB3=num2str(AB3);
title(['AB: ','zone1=',sAB,' zone2=',sAB2,' zone3=',sAB3])
hold on 
zone1(z1)
zone2(z1)
zone3(z1)
...
[rtest,xtest]=pol2cart(deg2rad(vtestF-itestF),vtestD./itestD);
BC=Foursquaretrip(rtest,xtest,z1,.85,cri1);
BC2=Foursquaretrip(rtest,xtest,z1,1.5,cri2);
BC3=Foursquaretrip(rtest,xtest,z1,2.2,cri3);
...
sBC2=num2str(BC2);
sBC3=num2str(BC3);
title(['BC: ','zone1=',sBC,' zone2=',sBC2,' zone3=',sBC3])
hold on 
zone1(z1)
zone2(z1)
zone3(z1)
...
CA=Foursquaretrip(rtest,xtest,z1,0.85,cri1);
CA2=Foursquaretrip(rtest,xtest,z1,1.5,cri2);
CA3=Foursquaretrip(rtest,xtest,z1,2.2,cri3);
...
sCA2=num2str(CA2);
sCA3=num2str(CA3);
title(['CA: ' ,'zone1=',sCA ,' zone2=',sCA2,' zone3=',sCA3])
hold on 
%plot(rtest2,xtest2)
zone1(z1)
zone2(z1)
